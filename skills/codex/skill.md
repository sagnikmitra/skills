...
When the user invokes `/codex` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/codex`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Codex/`
- Obsidian Vault — `Skills/Codex/`
...
_Source: ~/.claude/skills/codex/SKILL.md_
_Category: Codex_
