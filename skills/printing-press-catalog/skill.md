...
When the user invokes `/printing-press-catalog` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-catalog`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Catalog/`
- Obsidian Vault — `Skills/Printing Press Catalog/`
...
_Source: ~/.codex/skills/printing-press-catalog/SKILL.md_
_Category: General_
