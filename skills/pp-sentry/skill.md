...
When the user invokes `/pp-sentry` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-sentry`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Sentry/`
- Obsidian Vault — `Skills/Pp Sentry/`
...
_Source: ~/.codex/skills/pp-sentry/SKILL.md_
