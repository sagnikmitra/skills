...
When the user invokes `/plan-devex-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/plan-devex-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Plan Devex Review/`
- Obsidian Vault — `Skills/Plan Devex Review/`
...
_Source: ~/.claude/skills/plan-devex-review/SKILL.md_
_Category: Planning_
