...
When the user invokes `/document-release` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/document-release`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Document Release/`
- Obsidian Vault — `Skills/Document Release/`
...
_Source: ~/.claude/skills/document-release/SKILL.md_
_Category: General_
