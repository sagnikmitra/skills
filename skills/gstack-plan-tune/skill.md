...
When the user invokes `/gstack-plan-tune` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-plan-tune`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Plan Tune/`
- Obsidian Vault — `Skills/Gstack Plan Tune/`
...
_Source: ~/.claude/skills/gstack/plan-tune/SKILL.md_
_Category: General_
