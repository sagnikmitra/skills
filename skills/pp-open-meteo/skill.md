...
When the user invokes `/pp-open-meteo` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-open-meteo`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Open Meteo/`
- Obsidian Vault — `Skills/Pp Open Meteo/`
...
_Source: ~/.codex/skills/pp-open-meteo/SKILL.md_
