...
When the user invokes `/pp-hackernews` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-hackernews`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Hackernews/`
- Obsidian Vault — `Skills/Pp Hackernews/`
...
_Source: ~/.codex/skills/pp-hackernews/SKILL.md_
