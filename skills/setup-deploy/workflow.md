...
How the `setup-deploy` skill works, step by step.
...
20. User-invocable
21. Instructions
22. Deploy Configuration (configured by /setup-deploy)
23. Important Rules
...
- Claude — invoked via the `Skill` tool with `skill: "setup-deploy"`.
- Codex — referenced from `AGENTS.md` if mirrored.
- Antigravity — referenced from the workspace agent rules if mirrored.
- HQ Project — listed on the landing page Skills section + post-login sidebar.
- MD Project (md.sgnk.ai) — file rendered from `Skills/Setup Deploy/workflow.md`.
...
_Source: ~/.claude/skills/setup-deploy/WORKFLOW.md_
