...
When the user invokes `/setup-deploy` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/setup-deploy`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Setup Deploy/`
- Obsidian Vault — `Skills/Setup Deploy/`
...
_Source: ~/.claude/skills/setup-deploy/SKILL.md_
_Category: General_
