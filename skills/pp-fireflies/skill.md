...
When the user invokes `/pp-fireflies` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-fireflies`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Fireflies/`
- Obsidian Vault — `Skills/Pp Fireflies/`
...
_Source: ~/.codex/skills/pp-fireflies/SKILL.md_
