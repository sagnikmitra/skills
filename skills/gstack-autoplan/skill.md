...
When the user invokes `/gstack-autoplan` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-autoplan`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Autoplan/`
- Obsidian Vault — `Skills/Gstack Autoplan/`
...
_Source: ~/.claude/skills/gstack/autoplan/SKILL.md_
_Category: General_
