...
When the user invokes `/printing-press` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press/`
- Obsidian Vault — `Skills/Printing Press/`
...
_Source: ~/.codex/skills/printing-press/SKILL.md_
_Category: General_
