...
When the user invokes `/careful` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/careful`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Careful/`
- Obsidian Vault — `Skills/Careful/`
...
_Source: ~/.claude/skills/careful/SKILL.md_
_Category: General_
