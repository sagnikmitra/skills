...
When the user invokes `/pp-archive-is` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-archive-is`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Archive Is/`
- Obsidian Vault — `Skills/Pp Archive Is/`
...
_Source: ~/.codex/skills/pp-archive-is/SKILL.md_
