...
When the user invokes `/pp-craigslist` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-craigslist`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Craigslist/`
- Obsidian Vault — `Skills/Pp Craigslist/`
...
_Source: ~/.codex/skills/pp-craigslist/SKILL.md_
