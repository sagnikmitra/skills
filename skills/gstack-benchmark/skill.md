...
When the user invokes `/gstack-benchmark` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-benchmark`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Benchmark/`
- Obsidian Vault — `Skills/Gstack Benchmark/`
...
_Source: ~/.claude/skills/gstack/benchmark/SKILL.md_
_Category: General_
