...
When the user invokes `/printing-press-polish` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-polish`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Polish/`
- Obsidian Vault — `Skills/Printing Press Polish/`
...
_Source: ~/.codex/skills/printing-press-polish/SKILL.md_
_Category: General_
