...
When the user invokes `/gstack-landing-report` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-landing-report`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Landing Report/`
- Obsidian Vault — `Skills/Gstack Landing Report/`
...
_Source: ~/.claude/skills/gstack/landing-report/SKILL.md_
_Category: General_
