...
When the user invokes `/migrate-to-codex` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/migrate-to-codex`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Migrate To Codex/`
- Obsidian Vault — `Skills/Migrate To Codex/`
...
_Source: ~/.codex/skills/migrate-to-codex/SKILL.md_
_Category: General_
