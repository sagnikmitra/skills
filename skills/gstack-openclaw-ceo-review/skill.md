...
When the user invokes `/gstack-openclaw-ceo-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-openclaw-ceo-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Openclaw Ceo Review/`
- Obsidian Vault — `Skills/Gstack Openclaw Ceo Review/`
...
_Source: ~/.codex/skills/gstack-openclaw-ceo-review/SKILL.md_
_Category: General_
