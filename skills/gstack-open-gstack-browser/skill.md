...
When the user invokes `/gstack-open-gstack-browser` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-open-gstack-browser`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Open Gstack Browser/`
- Obsidian Vault — `Skills/Gstack Open Gstack Browser/`
...
_Source: ~/.claude/skills/gstack/open-gstack-browser/SKILL.md_
_Category: General_
