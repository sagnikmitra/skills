...
When the user invokes `/pp-roam` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-roam`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Roam/`
- Obsidian Vault — `Skills/Pp Roam/`
...
_Source: ~/.codex/skills/pp-roam/SKILL.md_
