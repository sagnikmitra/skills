...
When the user invokes `/plan-eng-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/plan-eng-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Plan Eng Review/`
- Obsidian Vault — `Skills/Plan Eng Review/`
...
_Source: ~/.claude/skills/plan-eng-review/SKILL.md_
_Category: Planning_
