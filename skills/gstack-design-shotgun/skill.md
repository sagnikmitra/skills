...
When the user invokes `/gstack-design-shotgun` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-design-shotgun`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Design Shotgun/`
- Obsidian Vault — `Skills/Gstack Design Shotgun/`
...
_Source: ~/.claude/skills/gstack/design-shotgun/SKILL.md_
_Category: General_
