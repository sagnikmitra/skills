...
When the user invokes `/gstack-setup-browser-cookies` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-setup-browser-cookies`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Setup Browser Cookies/`
- Obsidian Vault — `Skills/Gstack Setup Browser Cookies/`
...
_Source: ~/.claude/skills/gstack/setup-browser-cookies/SKILL.md_
_Category: General_
