...
When the user invokes `/canary` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/canary`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Canary/`
- Obsidian Vault — `Skills/Canary/`
...
_Source: ~/.claude/skills/canary/SKILL.md_
_Category: General_
