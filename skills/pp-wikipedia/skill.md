...
When the user invokes `/pp-wikipedia` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-wikipedia`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Wikipedia/`
- Obsidian Vault — `Skills/Pp Wikipedia/`
...
_Source: ~/.codex/skills/pp-wikipedia/SKILL.md_
