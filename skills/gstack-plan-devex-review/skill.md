...
When the user invokes `/gstack-plan-devex-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-plan-devex-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Plan Devex Review/`
- Obsidian Vault — `Skills/Gstack Plan Devex Review/`
...
_Source: ~/.claude/skills/gstack/plan-devex-review/SKILL.md_
_Category: General_
