...
How the `qa-only` skill works, step by step.
...
24. Prior Learnings
25. Test Plan Context
26. Modes
27. Workflow
28. Health Score Rubric
29. Framework-Specific Guidance
30. Important Rules
31. Output
32. Capture Learnings
33. Additional Rules (qa-only specific)
...
- Claude — invoked via the `Skill` tool with `skill: "qa-only"`.
- Codex — referenced from `AGENTS.md` if mirrored.
- Antigravity — referenced from the workspace agent rules if mirrored.
- HQ Project — listed on the landing page Skills section + post-login sidebar.
- MD Project (md.sgnk.ai) — file rendered from `Skills/Qa Only/workflow.md`.
...
_Source: ~/.claude/skills/qa-only/WORKFLOW.md_
