...
When the user invokes `/qa-only` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/qa-only`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Qa Only/`
- Obsidian Vault — `Skills/Qa Only/`
...
_Source: ~/.claude/skills/qa-only/SKILL.md_
_Category: General_
