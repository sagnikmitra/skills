...
When the user invokes `/gstack-pair-agent` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-pair-agent`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Pair Agent/`
- Obsidian Vault — `Skills/Gstack Pair Agent/`
...
_Source: ~/.claude/skills/gstack/pair-agent/SKILL.md_
_Category: General_
