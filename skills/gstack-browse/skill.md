...
When the user invokes `/gstack-browse` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-browse`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Browse/`
- Obsidian Vault — `Skills/Gstack Browse/`
...
_Source: ~/.claude/skills/gstack/browse/SKILL.md_
_Category: General_
