...
When the user invokes `/gstack-context-save` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-context-save`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Context Save/`
- Obsidian Vault — `Skills/Gstack Context Save/`
...
_Source: ~/.claude/skills/gstack/context-save/SKILL.md_
_Category: General_
