...
When the user invokes `/freeze` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/freeze`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Freeze/`
- Obsidian Vault — `Skills/Freeze/`
...
_Source: ~/.claude/skills/freeze/SKILL.md_
_Category: General_
