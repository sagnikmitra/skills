...
When the user invokes `/supabase` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/supabase`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Supabase/`
- Obsidian Vault — `Skills/Supabase/`
...
_Source: ~/.claude/skills/supabase/SKILL.md_
_Category: General_
