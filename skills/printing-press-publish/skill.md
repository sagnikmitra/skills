...
When the user invokes `/printing-press-publish` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-publish`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Publish/`
- Obsidian Vault — `Skills/Printing Press Publish/`
...
_Source: ~/.codex/skills/printing-press-publish/SKILL.md_
_Category: General_
