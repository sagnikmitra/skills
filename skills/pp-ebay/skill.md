...
When the user invokes `/pp-ebay` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-ebay`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Ebay/`
- Obsidian Vault — `Skills/Pp Ebay/`
...
_Source: ~/.codex/skills/pp-ebay/SKILL.md_
