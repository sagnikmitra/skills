...
When the user invokes `/gstack-investigate` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-investigate`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Investigate/`
- Obsidian Vault — `Skills/Gstack Investigate/`
...
_Source: ~/.claude/skills/gstack/investigate/SKILL.md_
_Category: General_
