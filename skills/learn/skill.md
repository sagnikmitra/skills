...
When the user invokes `/learn` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/learn`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Learn/`
- Obsidian Vault — `Skills/Learn/`
...
_Source: ~/.claude/skills/learn/SKILL.md_
_Category: General_
