...
When the user invokes `/gstack-plan-design-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-plan-design-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Plan Design Review/`
- Obsidian Vault — `Skills/Gstack Plan Design Review/`
...
_Source: ~/.claude/skills/gstack/plan-design-review/SKILL.md_
_Category: General_
