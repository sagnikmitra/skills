...
When the user invokes `/gstack-setup-deploy` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-setup-deploy`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Setup Deploy/`
- Obsidian Vault — `Skills/Gstack Setup Deploy/`
...
_Source: ~/.claude/skills/gstack/setup-deploy/SKILL.md_
_Category: General_
