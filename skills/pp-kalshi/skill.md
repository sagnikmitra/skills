...
When the user invokes `/pp-kalshi` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-kalshi`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Kalshi/`
- Obsidian Vault — `Skills/Pp Kalshi/`
...
_Source: ~/.codex/skills/pp-kalshi/SKILL.md_
