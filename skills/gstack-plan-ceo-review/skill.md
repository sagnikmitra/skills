...
When the user invokes `/gstack-plan-ceo-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-plan-ceo-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Plan Ceo Review/`
- Obsidian Vault — `Skills/Gstack Plan Ceo Review/`
...
_Source: ~/.claude/skills/gstack/plan-ceo-review/SKILL.md_
_Category: General_
