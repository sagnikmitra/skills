...
When the user invokes `/connect-chrome` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/connect-chrome`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Connect Chrome/`
- Obsidian Vault — `Skills/Connect Chrome/`
...
_Source: ~/.claude/skills/connect-chrome/SKILL.md_
_Category: General_
