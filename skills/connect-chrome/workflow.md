# Connect Chrome — Workflow

## Overview

How the `connect-chrome` skill works, step by step.
...
- Claude — invoked via the `Skill` tool with `skill: "connect-chrome"`.
- Codex — referenced from `AGENTS.md` if mirrored.
- Antigravity — referenced from the workspace agent rules if mirrored.
- HQ Project — listed on the landing page Skills section + post-login sidebar.
- MD Project (md.sgnk.ai) — file rendered from `Skills/Connect Chrome/workflow.md`.
...
_Source: ~/.claude/skills/connect-chrome/WORKFLOW.md_
