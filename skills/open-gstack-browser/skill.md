...
When the user invokes `/open-gstack-browser` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/open-gstack-browser`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Open Gstack Browser/`
- Obsidian Vault — `Skills/Open Gstack Browser/`
...
_Source: ~/.claude/skills/open-gstack-browser/SKILL.md_
_Category: General_
