...
When the user invokes `/gstack-design-consultation` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-design-consultation`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Design Consultation/`
- Obsidian Vault — `Skills/Gstack Design Consultation/`
...
_Source: ~/.claude/skills/gstack/design-consultation/SKILL.md_
_Category: General_
