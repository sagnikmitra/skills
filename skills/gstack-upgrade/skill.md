...
When the user invokes `/gstack-upgrade` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-upgrade`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Upgrade/`
- Obsidian Vault — `Skills/Gstack Upgrade/`
...
_Source: ~/.claude/skills/gstack-upgrade/SKILL.md_
_Category: General_
