...
When the user invokes `/context7-mcp` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/context7-mcp`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Context7 Mcp/`
- Obsidian Vault — `Skills/Context7 Mcp/`
...
_Source: ~/.claude/skills/context7-mcp/SKILL.md_
_Category: General_
