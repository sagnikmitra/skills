...
When the user invokes `/system-skill-creator` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/system-skill-creator`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/System Skill Creator/`
- Obsidian Vault — `Skills/System Skill Creator/`
...
_Source: ~/.codex/skills/.system/skill-creator/SKILL.md_
_Category: General_
