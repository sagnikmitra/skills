...
When the user invokes `/pp-apartments` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-apartments`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Apartments/`
- Obsidian Vault — `Skills/Pp Apartments/`
...
_Source: ~/.codex/skills/pp-apartments/SKILL.md_
