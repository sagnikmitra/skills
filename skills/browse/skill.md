...
When the user invokes `/browse` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/browse`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Browse/`
- Obsidian Vault — `Skills/Browse/`
...
_Source: ~/.claude/skills/browse/SKILL.md_
_Category: General_
