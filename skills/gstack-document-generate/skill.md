...
When the user invokes `/gstack-document-generate` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-document-generate`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Document Generate/`
- Obsidian Vault — `Skills/Gstack Document Generate/`
...
_Source: ~/.claude/skills/gstack/document-generate/SKILL.md_
_Category: General_
