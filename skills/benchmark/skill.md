...
When the user invokes `/benchmark` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/benchmark`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Benchmark/`
- Obsidian Vault — `Skills/Benchmark/`
...
_Source: ~/.claude/skills/benchmark/SKILL.md_
_Category: General_
