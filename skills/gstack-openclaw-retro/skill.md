...
When the user invokes `/gstack-openclaw-retro` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-openclaw-retro`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Openclaw Retro/`
- Obsidian Vault — `Skills/Gstack Openclaw Retro/`
...
_Source: ~/.codex/skills/gstack-openclaw-retro/SKILL.md_
_Category: General_
