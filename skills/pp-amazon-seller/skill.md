...
When the user invokes `/pp-amazon-seller` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-amazon-seller`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Amazon Seller/`
- Obsidian Vault — `Skills/Pp Amazon Seller/`
...
_Source: ~/.codex/skills/pp-amazon-seller/SKILL.md_
