...
When the user invokes `/gstack-office-hours` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-office-hours`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Office Hours/`
- Obsidian Vault — `Skills/Gstack Office Hours/`
...
_Source: ~/.claude/skills/gstack/office-hours/SKILL.md_
_Category: General_
