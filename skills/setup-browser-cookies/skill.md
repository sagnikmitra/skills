...
When the user invokes `/setup-browser-cookies` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/setup-browser-cookies`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Setup Browser Cookies/`
- Obsidian Vault — `Skills/Setup Browser Cookies/`
...
_Source: ~/.claude/skills/setup-browser-cookies/SKILL.md_
_Category: General_
