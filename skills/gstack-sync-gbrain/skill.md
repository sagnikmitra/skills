...
When the user invokes `/gstack-sync-gbrain` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-sync-gbrain`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Sync Gbrain/`
- Obsidian Vault — `Skills/Gstack Sync Gbrain/`
...
_Source: ~/.claude/skills/gstack/sync-gbrain/SKILL.md_
_Category: General_
