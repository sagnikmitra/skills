...
When the user invokes `/pp-redfin` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-redfin`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Redfin/`
- Obsidian Vault — `Skills/Pp Redfin/`
...
_Source: ~/.codex/skills/pp-redfin/SKILL.md_
