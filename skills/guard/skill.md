...
When the user invokes `/guard` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/guard`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Guard/`
- Obsidian Vault — `Skills/Guard/`
...
_Source: ~/.claude/skills/guard/SKILL.md_
_Category: General_
