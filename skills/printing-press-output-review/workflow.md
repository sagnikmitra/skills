# Printing Press Output Review — Workflow

## Overview

How the `printing-press-output-review` skill works, step by step.
...
- Claude — invoked via the `Skill` tool with `skill: "printing-press-output-review"`.
- Codex — referenced from `AGENTS.md` if mirrored.
- Antigravity — referenced from the workspace agent rules if mirrored.
- HQ Project — listed on the landing page Skills section + post-login sidebar.
- MD Project (md.sgnk.ai) — file rendered from `Skills/Printing Press Output Review/workflow.md`.
