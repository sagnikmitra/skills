...
When the user invokes `/gstack-design-html` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-design-html`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Design Html/`
- Obsidian Vault — `Skills/Gstack Design Html/`
...
_Source: ~/.claude/skills/gstack/design-html/SKILL.md_
_Category: General_
