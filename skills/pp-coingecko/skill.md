...
When the user invokes `/pp-coingecko` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-coingecko`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Coingecko/`
- Obsidian Vault — `Skills/Pp Coingecko/`
...
_Source: ~/.codex/skills/pp-coingecko/SKILL.md_
