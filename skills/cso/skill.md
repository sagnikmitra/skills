...
When the user invokes `/cso` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/cso`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Cso/`
- Obsidian Vault — `Skills/Cso/`
...
_Source: ~/.claude/skills/cso/SKILL.md_
_Category: General_
