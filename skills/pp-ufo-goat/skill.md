...
When the user invokes `/pp-ufo-goat` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-ufo-goat`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Ufo Goat/`
- Obsidian Vault — `Skills/Pp Ufo Goat/`
...
_Source: ~/.codex/skills/pp-ufo-goat/SKILL.md_
