...
When the user invokes `/design-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/design-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Design Review/`
- Obsidian Vault — `Skills/Design Review/`
...
_Source: ~/.claude/skills/design-review/SKILL.md_
_Category: Design_
