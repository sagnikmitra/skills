...
When the user invokes `/gstack-openclaw-office-hours` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-openclaw-office-hours`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Openclaw Office Hours/`
- Obsidian Vault — `Skills/Gstack Openclaw Office Hours/`
...
_Source: ~/.codex/skills/gstack-openclaw-office-hours/SKILL.md_
_Category: General_
