# Gstack Openclaw Office Hours — Workflow

## Overview

How the `gstack-openclaw-office-hours` skill works, step by step.
...
- Claude — invoked via the `Skill` tool with `skill: "gstack-openclaw-office-hours"`.
- Codex — referenced from `AGENTS.md` if mirrored.
- Antigravity — referenced from the workspace agent rules if mirrored.
- HQ Project — listed on the landing page Skills section + post-login sidebar.
- MD Project (md.sgnk.ai) — file rendered from `Skills/Gstack Openclaw Office Hours/workflow.md`.
