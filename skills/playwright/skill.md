...
When the user invokes `/playwright` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/playwright`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Playwright/`
- Obsidian Vault — `Skills/Playwright/`
...
_Source: ~/.codex/skills/playwright/SKILL.md_
_Category: General_
