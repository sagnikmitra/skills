...
When the user invokes `/investigate` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/investigate`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Investigate/`
- Obsidian Vault — `Skills/Investigate/`
...
_Source: ~/.claude/skills/investigate/SKILL.md_
_Category: General_
