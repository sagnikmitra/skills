...
When the user invokes `/pp-producthunt` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-producthunt`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Producthunt/`
- Obsidian Vault — `Skills/Pp Producthunt/`
...
_Source: ~/.codex/skills/pp-producthunt/SKILL.md_
