...
When the user invokes `/pp-ahrefs` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-ahrefs`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Ahrefs/`
- Obsidian Vault — `Skills/Pp Ahrefs/`
...
_Source: ~/.codex/skills/pp-ahrefs/SKILL.md_
