...
When the user invokes `/checkpoint` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/checkpoint`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Checkpoint/`
- Obsidian Vault — `Skills/Checkpoint/`
...
_Source: ~/.codex/skills/checkpoint/SKILL.md_
_Category: General_
