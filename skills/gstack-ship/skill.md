...
When the user invokes `/gstack-ship` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-ship`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Ship/`
- Obsidian Vault — `Skills/Gstack Ship/`
...
_Source: ~/.claude/skills/gstack/ship/SKILL.md_
_Category: General_
