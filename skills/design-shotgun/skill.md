...
When the user invokes `/design-shotgun` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/design-shotgun`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Design Shotgun/`
- Obsidian Vault — `Skills/Design Shotgun/`
...
_Source: ~/.claude/skills/design-shotgun/SKILL.md_
_Category: Design_
