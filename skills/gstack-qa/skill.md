...
When the user invokes `/gstack-qa` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-qa`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Qa/`
- Obsidian Vault — `Skills/Gstack Qa/`
...
_Source: ~/.claude/skills/gstack/qa/SKILL.md_
_Category: General_
