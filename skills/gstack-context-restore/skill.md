...
When the user invokes `/gstack-context-restore` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-context-restore`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Context Restore/`
- Obsidian Vault — `Skills/Gstack Context Restore/`
...
_Source: ~/.claude/skills/gstack/context-restore/SKILL.md_
_Category: General_
