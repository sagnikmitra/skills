...
When the user invokes `/pp-nvd` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-nvd`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Nvd/`
- Obsidian Vault — `Skills/Pp Nvd/`
...
_Source: ~/.codex/skills/pp-nvd/SKILL.md_
