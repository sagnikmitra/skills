...
When the user invokes `/pp-food52` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-food52`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Food52/`
- Obsidian Vault — `Skills/Pp Food52/`
...
_Source: ~/.codex/skills/pp-food52/SKILL.md_
