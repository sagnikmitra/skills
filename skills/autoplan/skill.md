...
When the user invokes `/autoplan` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/autoplan`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Autoplan/`
- Obsidian Vault — `Skills/Autoplan/`
...
_Source: ~/.claude/skills/autoplan/SKILL.md_
_Category: General_
