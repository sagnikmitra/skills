...
When the user invokes `/design-html` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/design-html`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Design Html/`
- Obsidian Vault — `Skills/Design Html/`
...
_Source: ~/.claude/skills/design-html/SKILL.md_
_Category: Design_
