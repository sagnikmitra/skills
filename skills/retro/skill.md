...
When the user invokes `/retro` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/retro`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Retro/`
- Obsidian Vault — `Skills/Retro/`
...
_Source: ~/.claude/skills/retro/SKILL.md_
_Category: General_
