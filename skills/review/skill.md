...
When the user invokes `/review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Review/`
- Obsidian Vault — `Skills/Review/`
...
_Source: ~/.claude/skills/review/SKILL.md_
_Category: General_
