...
When the user invokes `/health` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/health`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Health/`
- Obsidian Vault — `Skills/Health/`
...
_Source: ~/.claude/skills/health/SKILL.md_
_Category: General_
