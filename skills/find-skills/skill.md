...
When the user invokes `/find-skills` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/find-skills`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Find Skills/`
- Obsidian Vault — `Skills/Find Skills/`
...
_Source: ~/.codex/skills/find-skills/SKILL.md_
_Category: General_
