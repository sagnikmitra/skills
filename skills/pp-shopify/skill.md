...
- Claude (if synced from `~/.claude/skills/pp-shopify`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Shopify/`
- Obsidian Vault — `Skills/Pp Shopify/`
...
_Source: ~/.codex/skills/pp-shopify/SKILL.md_
