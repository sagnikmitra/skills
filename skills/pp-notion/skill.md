...
When the user invokes `/pp-notion` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-notion`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Notion/`
- Obsidian Vault — `Skills/Pp Notion/`
...
_Source: ~/.codex/skills/pp-notion/SKILL.md_
