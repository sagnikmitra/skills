...
When the user invokes `/pp-postman-explore` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-postman-explore`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Postman Explore/`
- Obsidian Vault — `Skills/Pp Postman Explore/`
...
_Source: ~/.codex/skills/pp-postman-explore/SKILL.md_
