...
When the user invokes `/react-native-skills` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/react-native-skills`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/React Native Skills/`
- Obsidian Vault — `Skills/React Native Skills/`
...
_Source: ~/.claude/skills/react-native-skills/SKILL.md_
_Category: General_
