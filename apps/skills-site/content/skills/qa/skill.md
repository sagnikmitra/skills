...
When the user invokes `/qa` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/qa`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Qa/`
- Obsidian Vault — `Skills/Qa/`
...
_Source: ~/.claude/skills/qa/SKILL.md_
_Category: General_
