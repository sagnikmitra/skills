...
When the user invokes `/pp-google-photos` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-google-photos`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Google Photos/`
- Obsidian Vault — `Skills/Pp Google Photos/`
...
_Source: ~/.codex/skills/pp-google-photos/SKILL.md_
