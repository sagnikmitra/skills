...
When the user invokes `/react-view-transitions` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/react-view-transitions`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/React View Transitions/`
- Obsidian Vault — `Skills/React View Transitions/`
...
_Source: ~/.claude/skills/react-view-transitions/SKILL.md_
_Category: General_
