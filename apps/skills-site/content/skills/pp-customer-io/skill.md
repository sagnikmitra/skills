...
When the user invokes `/pp-customer-io` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-customer-io`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Customer Io/`
- Obsidian Vault — `Skills/Pp Customer Io/`
...
_Source: ~/.codex/skills/pp-customer-io/SKILL.md_
