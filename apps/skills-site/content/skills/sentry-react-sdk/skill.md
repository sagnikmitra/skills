...
When the user invokes `/sentry-react-sdk` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/sentry-react-sdk`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Sentry React Sdk/`
- Obsidian Vault — `Skills/Sentry React Sdk/`
...
_Source: ~/.claude/skills/sentry-react-sdk/SKILL.md_
_Category: General_
