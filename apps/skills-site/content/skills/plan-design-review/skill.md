...
When the user invokes `/plan-design-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/plan-design-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Plan Design Review/`
- Obsidian Vault — `Skills/Plan Design Review/`
...
_Source: ~/.claude/skills/plan-design-review/SKILL.md_
_Category: Planning_
