...
When the user invokes `/pp-mercury` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-mercury`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Mercury/`
- Obsidian Vault — `Skills/Pp Mercury/`
...
_Source: ~/.codex/skills/pp-mercury/SKILL.md_
