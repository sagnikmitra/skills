...
When the user invokes `/gstack-qa-only` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-qa-only`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Qa Only/`
- Obsidian Vault — `Skills/Gstack Qa Only/`
...
_Source: ~/.claude/skills/gstack/qa-only/SKILL.md_
_Category: General_
