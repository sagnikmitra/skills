...
When the user invokes `/printing-press-output-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-output-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Output Review/`
- Obsidian Vault — `Skills/Printing Press Output Review/`
...
_Source: ~/.codex/skills/printing-press-output-review/SKILL.md_
_Category: General_
