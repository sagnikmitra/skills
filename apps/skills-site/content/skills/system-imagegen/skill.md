...
When the user invokes `/system-imagegen` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/system-imagegen`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/System Imagegen/`
- Obsidian Vault — `Skills/System Imagegen/`
...
_Source: ~/.codex/skills/.system/imagegen/SKILL.md_
_Category: General_
