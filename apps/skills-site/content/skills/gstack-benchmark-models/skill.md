...
When the user invokes `/gstack-benchmark-models` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-benchmark-models`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Benchmark Models/`
- Obsidian Vault — `Skills/Gstack Benchmark Models/`
...
_Source: ~/.claude/skills/gstack/benchmark-models/SKILL.md_
_Category: General_
