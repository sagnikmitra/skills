...
When the user invokes `/pp-dominos` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-dominos`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Dominos/`
- Obsidian Vault — `Skills/Pp Dominos/`
...
_Source: ~/.codex/skills/pp-dominos/SKILL.md_
