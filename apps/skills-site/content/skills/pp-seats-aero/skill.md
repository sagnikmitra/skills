...
Printing Press CLI for Seats Aero. Seats.aero Partner API for award travel availability, cached search, route lists, and trip revalidation details.
...
When the user invokes `/pp-seats-aero` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-seats-aero`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Seats Aero/`
- Obsidian Vault — `Skills/Pp Seats Aero/`
...
_Source: ~/.codex/skills/pp-seats-aero/SKILL.md_
