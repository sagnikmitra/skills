...
When the user invokes `/printing-press-retro` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-retro`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Retro/`
- Obsidian Vault — `Skills/Printing Press Retro/`
...
_Source: ~/.codex/skills/printing-press-retro/SKILL.md_
_Category: General_
