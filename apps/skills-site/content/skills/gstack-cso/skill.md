...
When the user invokes `/gstack-cso` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-cso`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Cso/`
- Obsidian Vault — `Skills/Gstack Cso/`
...
_Source: ~/.claude/skills/gstack/cso/SKILL.md_
_Category: General_
