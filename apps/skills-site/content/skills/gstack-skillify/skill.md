...
When the user invokes `/gstack-skillify` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-skillify`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Skillify/`
- Obsidian Vault — `Skills/Gstack Skillify/`
...
_Source: ~/.claude/skills/gstack/skillify/SKILL.md_
_Category: General_
