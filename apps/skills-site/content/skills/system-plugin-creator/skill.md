...
When the user invokes `/system-plugin-creator` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/system-plugin-creator`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/System Plugin Creator/`
- Obsidian Vault — `Skills/System Plugin Creator/`
...
_Source: ~/.codex/skills/.system/plugin-creator/SKILL.md_
_Category: General_
