...
When the user invokes `/design-consultation` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/design-consultation`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Design Consultation/`
- Obsidian Vault — `Skills/Design Consultation/`
...
_Source: ~/.claude/skills/design-consultation/SKILL.md_
_Category: Design_
