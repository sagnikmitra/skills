...
When the user invokes `/gstack-scrape` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-scrape`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Scrape/`
- Obsidian Vault — `Skills/Gstack Scrape/`
...
_Source: ~/.claude/skills/gstack/scrape/SKILL.md_
_Category: General_
