...
- Claude (if synced from `~/.claude/skills/pp-cal-com`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Cal Com/`
- Obsidian Vault — `Skills/Pp Cal Com/`
...
_Source: ~/.codex/skills/pp-cal-com/SKILL.md_
