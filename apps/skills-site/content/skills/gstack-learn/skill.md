...
When the user invokes `/gstack-learn` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-learn`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Learn/`
- Obsidian Vault — `Skills/Gstack Learn/`
...
_Source: ~/.claude/skills/gstack/learn/SKILL.md_
_Category: General_
