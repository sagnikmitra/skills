...
When the user invokes `/gstack-guard` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-guard`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Guard/`
- Obsidian Vault — `Skills/Gstack Guard/`
...
_Source: ~/.claude/skills/gstack/guard/SKILL.md_
_Category: General_
