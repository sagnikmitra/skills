...
When the user invokes `/gstack-design-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-design-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Design Review/`
- Obsidian Vault — `Skills/Gstack Design Review/`
...
_Source: ~/.claude/skills/gstack/design-review/SKILL.md_
_Category: General_
