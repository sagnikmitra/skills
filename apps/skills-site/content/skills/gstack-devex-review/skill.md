...
When the user invokes `/gstack-devex-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-devex-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Devex Review/`
- Obsidian Vault — `Skills/Gstack Devex Review/`
...
_Source: ~/.claude/skills/gstack/devex-review/SKILL.md_
_Category: General_
