...
When the user invokes `/deploy-to-vercel` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/deploy-to-vercel`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Deploy To Vercel/`
- Obsidian Vault — `Skills/Deploy To Vercel/`
...
_Source: ~/.claude/skills/deploy-to-vercel/SKILL.md_
_Category: General_
