...
When the user invokes `/pp-pypi` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-pypi`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Pypi/`
- Obsidian Vault — `Skills/Pp Pypi/`
...
_Source: ~/.codex/skills/pp-pypi/SKILL.md_
