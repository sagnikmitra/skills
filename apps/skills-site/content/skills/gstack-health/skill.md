...
When the user invokes `/gstack-health` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-health`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Health/`
- Obsidian Vault — `Skills/Gstack Health/`
...
_Source: ~/.claude/skills/gstack/health/SKILL.md_
_Category: General_
