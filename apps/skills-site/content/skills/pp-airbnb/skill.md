...
When the user invokes `/pp-airbnb` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-airbnb`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Airbnb/`
- Obsidian Vault — `Skills/Pp Airbnb/`
...
_Source: ~/.codex/skills/pp-airbnb/SKILL.md_
