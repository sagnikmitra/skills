...
When the user invokes `/plan-ceo-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/plan-ceo-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Plan Ceo Review/`
- Obsidian Vault — `Skills/Plan Ceo Review/`
...
_Source: ~/.claude/skills/plan-ceo-review/SKILL.md_
_Category: Planning_
