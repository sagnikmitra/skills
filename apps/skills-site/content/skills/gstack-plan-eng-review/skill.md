...
When the user invokes `/gstack-plan-eng-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-plan-eng-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Plan Eng Review/`
- Obsidian Vault — `Skills/Gstack Plan Eng Review/`
...
_Source: ~/.claude/skills/gstack/plan-eng-review/SKILL.md_
_Category: General_
