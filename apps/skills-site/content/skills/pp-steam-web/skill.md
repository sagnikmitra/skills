...
When the user invokes `/pp-steam-web` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-steam-web`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Steam Web/`
- Obsidian Vault — `Skills/Pp Steam Web/`
...
_Source: ~/.codex/skills/pp-steam-web/SKILL.md_
