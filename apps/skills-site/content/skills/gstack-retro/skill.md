...
When the user invokes `/gstack-retro` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-retro`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Retro/`
- Obsidian Vault — `Skills/Gstack Retro/`
...
_Source: ~/.claude/skills/gstack/retro/SKILL.md_
_Category: General_
