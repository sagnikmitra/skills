...
When the user invokes `/gstack-gstack-upgrade` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-gstack-upgrade`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Gstack Upgrade/`
- Obsidian Vault — `Skills/Gstack Gstack Upgrade/`
...
_Source: ~/.claude/skills/gstack/gstack-upgrade/SKILL.md_
_Category: General_
