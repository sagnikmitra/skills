...
When the user invokes `/find-docs` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/find-docs`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Find Docs/`
- Obsidian Vault — `Skills/Find Docs/`
...
_Source: ~/.claude/skills/find-docs/SKILL.md_
_Category: General_
