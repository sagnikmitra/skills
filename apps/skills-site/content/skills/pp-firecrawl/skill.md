...
When the user invokes `/pp-firecrawl` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-firecrawl`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Firecrawl/`
- Obsidian Vault — `Skills/Pp Firecrawl/`
...
_Source: ~/.codex/skills/pp-firecrawl/SKILL.md_
