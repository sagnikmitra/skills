...
When the user invokes `/pp-pagliacci` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-pagliacci`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Pagliacci/`
- Obsidian Vault — `Skills/Pp Pagliacci/`
...
_Source: ~/.codex/skills/pp-pagliacci/SKILL.md_
