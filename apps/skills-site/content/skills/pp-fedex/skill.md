...
When the user invokes `/pp-fedex` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-fedex`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Fedex/`
- Obsidian Vault — `Skills/Pp Fedex/`
...
_Source: ~/.codex/skills/pp-fedex/SKILL.md_
