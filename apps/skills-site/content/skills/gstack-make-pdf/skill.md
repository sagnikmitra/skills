...
When the user invokes `/gstack-make-pdf` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-make-pdf`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Make Pdf/`
- Obsidian Vault — `Skills/Gstack Make Pdf/`
...
_Source: ~/.claude/skills/gstack/make-pdf/SKILL.md_
_Category: General_
