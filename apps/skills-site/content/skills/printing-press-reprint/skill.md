...
When the user invokes `/printing-press-reprint` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-reprint`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Reprint/`
- Obsidian Vault — `Skills/Printing Press Reprint/`
...
_Source: ~/.codex/skills/printing-press-reprint/SKILL.md_
_Category: General_
