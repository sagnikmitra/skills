...
When the user invokes `/pp-espn` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-espn`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Espn/`
- Obsidian Vault — `Skills/Pp Espn/`
...
_Source: ~/.codex/skills/pp-espn/SKILL.md_
