...
When the user invokes `/printing-press-score` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-score`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Score/`
- Obsidian Vault — `Skills/Printing Press Score/`
...
_Source: ~/.codex/skills/printing-press-score/SKILL.md_
_Category: General_
