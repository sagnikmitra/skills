...
When the user invokes `/gstack-codex` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-codex`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Codex/`
- Obsidian Vault — `Skills/Gstack Codex/`
...
_Source: ~/.claude/skills/gstack/codex/SKILL.md_
_Category: General_
