...
When the user invokes `/office-hours` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/office-hours`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Office Hours/`
- Obsidian Vault — `Skills/Office Hours/`
...
_Source: ~/.claude/skills/office-hours/SKILL.md_
_Category: General_
