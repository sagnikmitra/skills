...
When the user invokes `/pp-weather-goat` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-weather-goat`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Weather Goat/`
- Obsidian Vault — `Skills/Pp Weather Goat/`
...
_Source: ~/.codex/skills/pp-weather-goat/SKILL.md_
