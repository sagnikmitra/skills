...
When the user invokes `/ship` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/ship`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Ship/`
- Obsidian Vault — `Skills/Ship/`
...
_Source: ~/.claude/skills/ship/SKILL.md_
_Category: General_
