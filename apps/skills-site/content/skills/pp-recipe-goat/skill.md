...
When the user invokes `/pp-recipe-goat` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-recipe-goat`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Recipe Goat/`
- Obsidian Vault — `Skills/Pp Recipe Goat/`
...
_Source: ~/.codex/skills/pp-recipe-goat/SKILL.md_
