...
- Claude (if synced from `~/.claude/skills/pp-clarity`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Clarity/`
- Obsidian Vault — `Skills/Pp Clarity/`
...
_Source: ~/.codex/skills/pp-clarity/SKILL.md_
