...
When the user invokes `/pp-flight-goat` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-flight-goat`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Flight Goat/`
- Obsidian Vault — `Skills/Pp Flight Goat/`
...
_Source: ~/.codex/skills/pp-flight-goat/SKILL.md_
