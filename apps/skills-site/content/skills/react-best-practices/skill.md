...
When the user invokes `/react-best-practices` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/react-best-practices`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/React Best Practices/`
- Obsidian Vault — `Skills/React Best Practices/`
...
_Source: ~/.claude/skills/react-best-practices/SKILL.md_
_Category: General_
