...
When the user invokes `/gstack` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack/`
- Obsidian Vault — `Skills/Gstack/`
...
_Source: ~/.claude/skills/gstack/SKILL.md_
_Category: General_
