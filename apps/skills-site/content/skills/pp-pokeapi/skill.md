...
When the user invokes `/pp-pokeapi` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-pokeapi`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Pokeapi/`
- Obsidian Vault — `Skills/Pp Pokeapi/`
...
_Source: ~/.codex/skills/pp-pokeapi/SKILL.md_
