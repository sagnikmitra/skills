...
When the user invokes `/devex-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/devex-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Devex Review/`
- Obsidian Vault — `Skills/Devex Review/`
...
_Source: ~/.claude/skills/devex-review/SKILL.md_
_Category: General_
