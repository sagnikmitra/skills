...
When the user invokes `/pp-docker-hub` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-docker-hub`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Docker Hub/`
- Obsidian Vault — `Skills/Pp Docker Hub/`
...
_Source: ~/.codex/skills/pp-docker-hub/SKILL.md_
