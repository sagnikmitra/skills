...
When the user invokes `/gstack-setup-gbrain` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-setup-gbrain`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Setup Gbrain/`
- Obsidian Vault — `Skills/Gstack Setup Gbrain/`
...
_Source: ~/.claude/skills/gstack/setup-gbrain/SKILL.md_
_Category: General_
