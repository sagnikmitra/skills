...
When the user invokes `/gstack-openclaw-investigate` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-openclaw-investigate`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Openclaw Investigate/`
- Obsidian Vault — `Skills/Gstack Openclaw Investigate/`
...
_Source: ~/.codex/skills/gstack-openclaw-investigate/SKILL.md_
_Category: General_
