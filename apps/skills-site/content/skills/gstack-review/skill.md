...
When the user invokes `/gstack-review` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-review`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Review/`
- Obsidian Vault — `Skills/Gstack Review/`
...
_Source: ~/.claude/skills/gstack/review/SKILL.md_
_Category: General_
