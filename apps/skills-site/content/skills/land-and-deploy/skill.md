...
When the user invokes `/land-and-deploy` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/land-and-deploy`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Land And Deploy/`
- Obsidian Vault — `Skills/Land And Deploy/`
...
_Source: ~/.claude/skills/land-and-deploy/SKILL.md_
_Category: General_
