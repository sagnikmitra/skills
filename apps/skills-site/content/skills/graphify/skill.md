...
When the user invokes `/graphify` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/graphify`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Graphify/`
- Obsidian Vault — `Skills/Graphify/`
...
_Source: ~/.claude/skills/graphify/SKILL.md_
_Category: General_
