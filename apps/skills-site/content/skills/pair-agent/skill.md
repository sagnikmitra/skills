...
When the user invokes `/pair-agent` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pair-agent`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pair Agent/`
- Obsidian Vault — `Skills/Pair Agent/`
...
_Source: ~/.claude/skills/pair-agent/SKILL.md_
_Category: General_
