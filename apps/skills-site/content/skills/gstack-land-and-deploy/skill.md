...
When the user invokes `/gstack-land-and-deploy` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-land-and-deploy`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Land And Deploy/`
- Obsidian Vault — `Skills/Gstack Land And Deploy/`
...
_Source: ~/.claude/skills/gstack/land-and-deploy/SKILL.md_
_Category: General_
