...
When the user invokes `/gstack-canary` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-canary`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Canary/`
- Obsidian Vault — `Skills/Gstack Canary/`
...
_Source: ~/.claude/skills/gstack/canary/SKILL.md_
_Category: General_
