...
When the user invokes `/gstack-freeze` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-freeze`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Freeze/`
- Obsidian Vault — `Skills/Gstack Freeze/`
...
_Source: ~/.claude/skills/gstack/freeze/SKILL.md_
_Category: General_
