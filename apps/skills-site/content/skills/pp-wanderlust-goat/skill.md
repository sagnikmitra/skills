...
- Claude (if synced from `~/.claude/skills/pp-wanderlust-goat`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Wanderlust Goat/`
- Obsidian Vault — `Skills/Pp Wanderlust Goat/`
...
_Source: ~/.codex/skills/pp-wanderlust-goat/SKILL.md_
