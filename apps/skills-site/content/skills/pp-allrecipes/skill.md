...
When the user invokes `/pp-allrecipes` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/pp-allrecipes`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Pp Allrecipes/`
- Obsidian Vault — `Skills/Pp Allrecipes/`
...
_Source: ~/.codex/skills/pp-allrecipes/SKILL.md_
