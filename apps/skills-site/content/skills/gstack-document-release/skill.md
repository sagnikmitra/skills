...
When the user invokes `/gstack-document-release` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/gstack-document-release`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Gstack Document Release/`
- Obsidian Vault — `Skills/Gstack Document Release/`
...
_Source: ~/.claude/skills/gstack/document-release/SKILL.md_
_Category: General_
