...
When the user invokes `/printing-press-import` or describes a task the skill's description matches.
...
- Claude (if synced from `~/.claude/skills/printing-press-import`)
- HQ Project — landing page Skills section
- MD Project (md.sgnk.ai) — `Skills/Printing Press Import/`
- Obsidian Vault — `Skills/Printing Press Import/`
...
_Source: ~/.codex/skills/printing-press-import/SKILL.md_
_Category: General_
